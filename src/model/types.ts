...
// ^ keep as-is for migration compatibility
...
export interface PaperPublishSettings {
  version: number;
...
export const DEFAULT_SETTINGS: PaperPublishSettings = {
...
export const TRACKED_SETTINGS_PATHS: (keyof PaperPublishSettings)[] = [
  "version",
  "projects",
