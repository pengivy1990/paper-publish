...
export const VIEW_TYPE_PAPER_PUBLISH_EXPLORER = "VIEW_TYPE_PAPER_PUBLISH_EXPLORER";
...
export class ExplorerPane extends ItemView {
  ...
  getViewType(): string {
    return VIEW_TYPE_PAPER_PUBLISH_EXPLORER;
  }
  ...
  async onOpen(): Promise<void> {
    ...
    context.set(
      ...
      (path: string, x: number, y: number, onRename: () => void) => {
        ...
        this.app.workspace.trigger("file-menu", menu, file, "paper-publish");
